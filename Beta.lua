...
local function Attack(Method)
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, math.huge, "ground_slash")
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, 919, "ground_slash")
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, math.huge, "ground_slash")
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, 919, "ground_slash")
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, math.huge, "ground_slash")
    HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, 919, "ground_slash")
    ...
    --     HandleFireServer:FireServer(Method, LocalPlayer, LocalPlayer.Character, LocalPlayer.Character.HumanoidRootPart, LocalPlayer.Character.Humanoid, DamageAmounts[i], "ground_slash")
